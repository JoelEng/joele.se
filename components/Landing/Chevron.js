  ...
  return (
    <div className={styles.ChevronContainer}>
      <div className={styles.ButtonContainer}>
        ...
        <a href="https://www.facebook.com/joel.engstrom.1460/" target="_blank" rel="noopener noreferrer">
          <Facebook className={styles.SmallButton} />
        </a>
      </div>
...
const GitHub = props => (
  <svg {...props} viewBox="0 0 512 512" width="30px" fill="var(--background)">
